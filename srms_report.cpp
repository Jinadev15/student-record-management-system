...
void ReportGenerator::printReport()
{
    ...
    /*
     * Performance percentage = cgpa * 10
     * This works because CGPA is on a scale of 0-10,
     * so multiplying by 10 converts it to a 0-100% scale.
     * Example: CGPA 8.5 -> 85% performance score.
     */
    cout << "  |  Performance: [";
    ...
    cout << "] " << fixed << setprecision(1) 
         << (cgpa * 10) << "/100" << "  |" << endl;
    cout << "  |  (Performance = CGPA x 10 = equivalent score)      |"
         << endl;
